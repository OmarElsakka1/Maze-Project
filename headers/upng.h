...
*		distribution.
*
* See this link: https://github.com/elanthis/upng/blob/master/upng.h
*/
...
typedef enum upng_error
{
	...
	UPNG_ENOTFOUND		= 2, /* resource not found (if file missing) */
	...
	UPNG_EPARAM			= 8  /* the invalid parameter to method call */
} upng_error;
