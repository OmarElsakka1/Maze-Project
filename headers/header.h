...
extern bool the_game_running;

/* Functions-variables-structs for drawing */
...
/* Functions-variables-structs for mapping */
 ...
 * @walkDirection: the walk Direction
 * @rotationAngle: the player rotation angle
 ...
 * @wallHitX: the wall hit x coordinate
 * @wallHitY: the wall hit x coordinate
 * @distance: the ditance to the wall
 * @wasHitVertical: verifying hit vertical
 * @wallHitContent: the wall hit content
 */
 ...
 * @texture_buffer: the pointer to texture buffer
 * @upngTexture: the pointer to upng buffer
 *
 */
